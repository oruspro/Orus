...
// Génère 4 paquets de 52 cartes (208 cartes)
function generateDeck4(): Card[] {
  const suits = [
    ...
    <div class="page-container">
      ...
      <header class="header">
        ...
        <div class="header-content">
          <h1 class="page-title">
            Marathon <span class="text-gradient">208</span>
            <span *ngIf="ranked" class="badge-ranked">Classé</span>
          </h1>
          <p class="subtitle">Mémorisez 4 paquets complets (208 cartes).</p>
        </div>
      </header>
      ...
      <section *ngIf="phase === 'pre'" class="glass-card centered-panel">
        <div class="pre-content">
          ...
          <p class="pre-hint">Préparez vos palais mentaux...</p>
        </div>
      </section>
      ...
      <section *ngIf="phase === 'mem'" class="game-board">
        ...
        <div class="hud-bar glass-card">
          ...
          <div class="hud-item">
            ...
            <span class="hud-value">{{ memIndex + 1 }}<span class="total">/{{ deck.length }}</span></span>
          </div>
        </div>
      ...
      <section *ngIf="phase === 'result'" class="glass-card result-panel">
        ...
        <div class="stats-grid">
          <div class="stat-item">
            ...
            <span class="stat-val">{{ goodCount }}/{{ deck.length }}</span>
          </div>
          <div class="stat-item">
...
export class Cartes4TrialComponent implements OnInit, OnDestroy {
  ...
  // Timer vars
  timeLeft = 600; // 10 minutes pour 208 cartes
  timerId: any;
  preTimeLeft = 3;
  preTimerId: any;
  memDuration = 0;
  ...
  toRecap() {
    ...
    if (this.timerId) clearInterval(this.timerId);
    // temps utilisé
    this.memDuration = 600 - this.timeLeft;
  ...
  computeScore(): number {
    ...
    const MAX_MEM = 600; // 10 minutes pour 4 paquets
  ...
  private onGameFinished() {
    ...
    this.statsService.recordScore('cartes4', this.finalScore, this.ranked);
